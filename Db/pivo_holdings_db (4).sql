...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2026 at 10:59 AM
...
(1, 7, 6, '2026-01-18 15:00:41'),
(2, 8, 5, '2026-01-18 15:00:56'),
(3, 5, 10, '2026-01-18 15:27:45'),
(4, 2, 890, '2026-01-18 15:01:23'),
(5, 3, 100, '2026-01-18 15:01:40');
...
(26, 4, NULL, '2026-02-06 16:04:30', 'Pending', 500.00, NULL, NULL, '2026-02-06 16:04:30', 0);
...
CREATE TABLE `products` (
  `product_id` int(11) NOT NULL,
  `product_name` enum('Mix Fruit','Mango','Wood Apple','Aloe Vera') NOT NULL,
...
(337, 1, 147, '2026-02-01', NULL),
(338, 1, 174, '2026-03-01', NULL),
(339, 1, 201, '2026-04-01', NULL),
(340, 3, 106, '2026-02-01', NULL),
(341, 3, 132, '2026-03-01', NULL),
(342, 3, 158, '2026-04-01', NULL),
(343, 6, 0, '2026-02-01', NULL),
(344, 6, 0, '2026-03-01', NULL),
(345, 6, 0, '2026-04-01', NULL),
(346, 8, 0, '2026-02-01', NULL),
(347, 8, 0, '2026-03-01', NULL),
(348, 8, 0, '2026-04-01', NULL);
...
(1, 0, 'City Supermarket', 'Mr. Perera', '123 Main St, Colombo', NULL, NULL, NULL, NULL),
(2, 0, 'Nature\'s Basket', 'Ms. Silva', '45 Orchid Lane, Kandy', NULL, NULL, NULL, NULL),
(3, 0, 'Organic Life Hub', 'Mr. Fernando', '88 Green Road, Galle', NULL, NULL, NULL, NULL),
(4, 8, 'dqwfes', NULL, 'fghj', '0717627634', NULL, NULL, NULL);
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `full_name`, `role`, `email`, `contact_number`, `created_at`) VALUES
(8, 'shop2', '$2y$10$eR4vjlZO4pUO22BZnjxqK.8nJk/4lTAtuvdHcUgv/Jk8pZbmcE/2u', NULL, 'ShopOwner', 'shop@shop.com', NULL, '2026-02-06 16:03:19'),
(9, 'shop1', '$2y$10$yQyKqtNy2MXzZQn8VS0/TOFAEAjy5ePyLu7kwdV2Q4vMXb64/DDNK', 'Primary Shop Owner', 'ShopOwner', 'shop1@pivo.lk', NULL, '2026-02-06 17:09:18'),
(10, 'manager', '$2y$10$PmNioPzDTHpX7BW9UpQW4eISiWYG8Gs8vj2ZDWTj0B0tnZlH2msNe', 'Regional Store Manager', 'StoreManager', 'manager@pivo.lk', NULL, '2026-02-06 17:09:18'),
(11, 'driver', '$2y$10$QymfgJKQJlz4.O0XO4lxeuXICPbmCb5eZ4mI8LR9KvNe4kgBbn5Wm', 'Lead Sales Rep', 'SalesRep', 'driver@pivo.lk', NULL, '2026-02-06 17:09:18'),
(12, 'admin', '$2y$10$./mBhWGyzX2KxGuuZKMfJOKfwWUkEr7j7RzgmC6xKA3AyYRJqVgX2', 'System Administrator', 'Admin', 'admin@pivo.lk', NULL, '2026-02-06 17:09:18'),
(13, 'factory', '$2y$10$dtvzIWO3ttRKDhZ5XErSEe.f5/.lAYGSgISdJysFAgGi6dIhBhBPu', 'Factory Proprietor', 'FactoryOwner', 'owner@pivo.lk', NULL, '2026-02-06 17:09:18'),
(14, 'shop', '$2y$10$B.xZ.7wSAs1d1gNQ.P385OHG6hr2IMJ0xpJHwL3W51d9rYFHjWqwS', NULL, 'ShopOwner', 'shop@shop.com', NULL, '2026-02-06 17:16:24');
...
--
ALTER TABLE `sales_predictions`
  MODIFY `prediction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=349;
