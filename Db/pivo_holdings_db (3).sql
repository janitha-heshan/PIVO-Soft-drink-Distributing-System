...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2026 at 03:47 PM
...
INSERT INTO `products` (`product_id`, `product_name`, `image_path`, `volume_ml`, `unit_price`, `description`) VALUES
(1, 'Mango', NULL, 'Large', 450.00, 'Organic Fresh Mango Juice - 1L'),
(2, 'Mango', NULL, 'Medium', 250.00, 'Organic Fresh Mango Juice - 500ml'),
(3, 'Mix Fruit', NULL, 'Large', 480.00, 'Organic Tropical Mix Fruit - 1L'),
(4, 'Mix Fruit', NULL, 'Small', 150.00, 'Organic Tropical Mix Fruit - 250ml'),
(5, 'Aloe Vera', NULL, 'Medium', 300.00, 'Natural Aloe Vera Refresh - 500ml'),
(6, 'Aloe Vera', NULL, 'Small', 180.00, 'Natural Aloe Vera Refresh - 250ml'),
(7, 'Wood Apple', NULL, 'Large', 420.00, 'Traditional Organic Wood Apple - 1L'),
(8, 'Wood Apple', NULL, 'Medium', 220.00, 'Traditional Organic Wood Apple - 500ml');
...
(301, 1, 147, '2026-02-01', NULL),
(302, 1, 174, '2026-03-01', NULL),
(303, 1, 201, '2026-04-01', NULL),
(304, 3, 106, '2026-02-01', NULL),
(305, 3, 132, '2026-03-01', NULL),
(306, 3, 158, '2026-04-01', NULL),
(307, 6, 0, '2026-02-01', NULL),
(308, 6, 0, '2026-03-01', NULL),
(309, 6, 0, '2026-04-01', NULL),
(310, 8, 0, '2026-02-01', NULL),
(311, 8, 0, '2026-03-01', NULL),
(312, 8, 0, '2026-04-01', NULL);
...
--
ALTER TABLE `sales_predictions`
  MODIFY `prediction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=313;
