...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            canvas { max-width: 350px !important; margin: 0 auto; }
                ...
                <div class="flex flex-wrap justify-between items-end gap-3 p-4">
                    ...
                    <div class="flex items-end gap-3 no-print">
                        <form method="GET" action="insights.php" class="flex flex-col gap-1">
                            <label for="time_frame" class="text-xs font-bold text-[#4c809a] uppercase">Time Frame</label>
                        ...
                        <button onclick="window.print()" class="flex items-center gap-2 bg-[#4c809a] hover:bg-[#3a6377] text-white px-4 rounded-lg text-sm font-bold transition-colors shadow-sm h-[42px]">
                ...
                <div class="p-4 chart-box">
                    <div class="flex flex-col gap-2 rounded-xl border border-[#cfdfe7] p-6 bg-white shadow-sm">
                        ...
                        <div class="flex justify-center items-center min-h-[350px]">
                            ...
                            <?php else: ?>
                                <div class="text-center p-10 bg-slate-50 rounded-lg border-2 border-dashed border-slate-200 w-full">
                        ...
                        <table class="w-full text-left text-sm">
                            <tbody class="divide-y divide-slate-100">
                                <?php if($topSellingResult && $topSellingResult->num_rows > 0): ?>
                                    ...
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="2" class="px-4 py-3 text-center text-slate-400 italic">No records found</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
